...
## Where do I find my Worker ID and Registration Code?
If you are running the Windows or MacOS desktop application you will be prompted to enter a Worker ID and registration code before starting your worker. These can be located when you click "Launch Worker" in the web console and you select the "desktop" version of the worker to run. Simply copy and paste the values into the desktop application and then start your worker.
